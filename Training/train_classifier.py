...
usecols = ["text"]
feedback_df = pd.read_csv("Feedback_500.csv", index_col="index")
functionality_df = pd.read_csv("Functionality_500.csv", index_col="index")
personal_exp_df = pd.read_csv("Personal Experience_500.csv", index_col="index")
pricing_df = pd.read_csv("Pricing_500.csv", index_col="index")
question_df = pd.read_csv("Question_500.csv", index_col="index")
suggestion_df = pd.read_csv("Suggestion_500.csv", index_col="index")
...
data_df = pd.concat([feedback_df, functionality_df, personal_exp_df,
                     pricing_df, question_df, suggestion_df], axis=0, ignore_index=True)
