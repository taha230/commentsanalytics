...
urlpatterns = [
    ...
    re_path('^blog/', views.homepage_blog_tutorial, name="blog"), # should redirect to blog admin wordpress
    re_path(r'tutorials/', views.homepage_blog_tutorial, name='tutorials'),
    ...
    re_path(r'^requests_ner_analytics_client/', views.requests_ner_analytics_client, name="requests_ner_analytics_client"), # use regular expression for handle all pages /P*
    re_path(r'^requests_keyword_analytics_client/', views.requests_keyword_analytics_client, name="requests_keyword_analytics_client"), # use regular expression for handle all pages /P*
    re_path(r'^requests_category_youtube_analytics_client/', views.requests_category_youtube_analytics_client, name="requests_category_youtube_analytics_client"), # use regular expression for handle all pages /P*
    ...
    re_path(r'^requests_ner_analytics_bulk/', views.requests_ner_analytics_bulk, name="requests_ner_analytics_bulk"), # use regular expression for handle all pages /P*
    re_path(r'^requests_keyword_analytics_bulk/', views.requests_keyword_analytics_bulk, name="requests_keyword_analytics_bulk"), # use regular expression for handle all pages /P*
    re_path(r'^requests_category_youtube_analytics_bulk/', views.requests_category_youtube_analytics_bulk, name="requests_category_youtube_analytics_bulk"), # use regular expression for handle all pages /P*
    re_path(r'^update_bulk_ner_analytics_ajax_client/', views.update_bulk_ner_analytics_ajax_client, name="update_bulk_ner_analytics_ajax_client"), # use regular expression for handle all pages /P*
    re_path(r'^update_bulk_category_youtube_analytics_ajax_client/', views.update_bulk_category_youtube_analytics_ajax_client, name="update_bulk_category_youtube_analytics_ajax_client"), # use regular expression for handle all pages /P*
    re_path(r'^update_bulk_keyword_analytics_ajax_client/', views.update_bulk_keyword_analytics_ajax_client, name="update_bulk_keyword_analytics_ajax_client"), # use regular expression for handle all pages /P*
    ...
    re_path(r'^requests_sentiment_single_client/', views.requests_sentiment_single_client, name="requests_sentiment_single_client"), # use regular expression for handle all pages /P*
    re_path(r'^requests_ner_single_client/', views.requests_ner_single_client, name="requests_ner_single_client"), # use regular expression for handle all pages /P*
    re_path(r'^requests_keyword_single_client/', views.requests_keyword_single_client, name="requests_keyword_single_client"), # use regular expression for handle all pages /P*
    re_path(r'^requests_category_single_client/', views.requests_category_single_client, name="requests_category_single_client"), # use regular expression for handle all pages /P*
    ...
    re_path(r'bulk_export_sentiment_csv/', views.export_bulk_sentiment_csv, name="bulk_export_sentiment"),
    re_path(r'bulk_export_category_csv/', views.export_bulk_category_csv, name="bulk_export_sentiment"),
    re_path(r'bulk_export_sentiment_xlsx/', views.export_bulk_sentiment_xlsx, name="bulk_export_category"),
    re_path(r'bulk_export_category_xlsx/', views.export_bulk_category_xlsx, name="bulk_export_category"),
    re_path(r'bulk_export_ner_csv/', views.export_bulk_ner_csv, name="bulk_export_ner"),
    re_path(r'bulk_export_keyword_csv/', views.export_bulk_keyword_csv, name="bulk_export_keyword"),
    re_path(r'bulk_export_ner_xlsx/', views.export_bulk_ner_xlsx, name="bulk_export_ner"),
    re_path(r'bulk_export_keyword_xlsx/', views.export_bulk_keyword_xlsx, name="bulk_export_keyword"),
    ...
    re_path(r'^admin_blog/', views.admin_blog, name="admin_blog"), # use regular expression for handle all pages /P*
    ...
    re_path(r'^delete_bulk_admin/bulk_', views.delete_bulk_admin, name="delete_bulk_admin"), # use regular expression for handle all pages /user_*
